# VideoCompress
A Telegram Video Compressor Bot By [@kidszonacompa](https://t.me/mrsschan). **This bot works for all!** No need to define each user IDs to use bot. Also works in Group.
