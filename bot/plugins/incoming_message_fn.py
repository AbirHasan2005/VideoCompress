    ...
    if update_channel:
        try:
            ...
            if user.status == "kicked":
               await bot.send_message("Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/linux_repo).", parse_mode="markdown")
               return
            ...
            await bot.send_message("Something went Wrong. Contact my [Support Group](https://t.me/linux_repo).", parse_mode="markdown")
            return
    await bot.send_message(
